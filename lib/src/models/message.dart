...
class AtTextElem {
  ...
  AtTextElem.fromJson(Map<String, dynamic> json) {
    ...
    if (json['atUsersInfo'] is List) {
      atUsersInfo =
          (json['atUsersInfo'] as List)
              .map((e) => AtUserInfo.fromJson(e))
              .toList();
    }
    quoteMessage =
        null != json['quoteMessage']
...
class RichMessageInfo {
  ...
  RichMessageInfo({this.type, this.offset, this.length, this.url, this.info});
