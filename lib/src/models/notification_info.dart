...
import '../../flutter_openim_ffi.dart';
  ...
  InvitedJoinGroupNotification.fromJson(Map<String, dynamic> json) {
    ...
    opUser =
        json['opUser'] != null
            ...
            : null;
    inviterUser =
        json['inviterUser'] != null
            ? GroupMembersInfo.fromJson(json['inviterUser'])
            : null;
